...
* Secciones de la aplicación
    1. Acceder a la API sin Postman en [localhost:8090/market/api/{recurso}/peticion](http://localhost:8090/market/api/{recurso}/peticion)  
    Los dos recursos a los que se puede acceder son:  
        - /products
        - /purchases
    2. Acceder a la documentación de la API que ofrece Swagger en [localhost:8090/market/api/swagger-ui/index.html](http://localhost:8090/market/api/swagger-ui/index.html)
